...
class UserProperties extends Component{
    ...
    render(){
        ...
        <div>
            ...
            <form  onSubmit={this.submitChange} name="increaseWeight">
                <label>
                    New user level:
                ...
                <label>
                    Update instantly?
                    <input type="checkBox" name="increaseWeightInstantly" value={state.formProperties.increaseWeightInstantly} onChange={this.handleChange}/>
                </label>
                <br/>
